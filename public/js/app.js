...
var FormController = /*#__PURE__*/function () {
  function FormController(formId) {
  ...
  _createClass(FormController, [{
    ...
    key: "handleSuccess",
    value: function handleSuccess(_res) {
      this.$responseLabel.text('Thank you for your submission! You should receive a copy of your inquiry shortly via email.').show();
    }
  }, {
    key: "handleFailure",
    value: function handleFailure(res) {
      var response = res.responseJSON;

      if ('errors' in response) {
        $.each(response.errors, this.setValidationState.bind(this));
      } else {
        this.$responseLabel.text('Something went wrong :( please try again').show();
      }
    }
  }, {
...
__webpack_require__(/*! /srv/dealer_inspire/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /srv/dealer_inspire/resources/sass/app.scss */"./resources/sass/app.scss");
